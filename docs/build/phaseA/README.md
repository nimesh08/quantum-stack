...
top-level [plan](../../../../.cursor/plans/phase_a_spinor_build_8cdb45ee.plan.md)
is the strategic index; this folder is where every milestone is
nailed down in detail before any code is written.
