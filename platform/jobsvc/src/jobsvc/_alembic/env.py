...
This file lives inside the `jobsvc` package so the wheel ships its own
migrations. The launcher's `heisenberg init` points alembic at this
script via the in-package `alembic.ini`.
"""
